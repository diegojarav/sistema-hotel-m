    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
            ...
            <div className="relative w-full max-w-md">
                {/* Glassmorphism card */}
                <div className="bg-white border border-gray-200 rounded-3xl shadow-2xl p-8 md:p-10">
                    {/* Hotel Branding */}
                    ...
                    {/* Error Alert */}
                    {error && (
                        <div className="mb-6 p-4 rounded-xl bg-red-50 border border-red-200 text-red-600 text-sm text-center animate-pulse">
                            {error}
                        </div>
                    )}
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                required
                                className="w-full pl-12 pr-4 py-4 bg-gray-50 border border-gray-300 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500/50 transition-all duration-200 text-lg"
                            />
                        </div>
